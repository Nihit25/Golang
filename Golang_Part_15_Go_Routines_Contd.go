...
//RLock is a shared read lock. When a lock is taken with it, other threads* can also take their own lock with RLock. 
// This means multiple threads* can read at the same time. It's semi-exclusive.
