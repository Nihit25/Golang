// here we are learning arrays and slices 
package main
...
func main() {
	...
	fmt.Println((sum))
	//slice - its just a part of an array, 
  // imp part - it will have a length and a capacity where capacity is the number of elements that can be accomodated inside that slice after reslicing
