...
func main() {
	...
	delete(mp, "pear")
	val, ok := mp["apple"] 
  // if apple key exists then its val is stored in "val" and ok will be true, else default value will get stored and ok will be false
